...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container">
        <div class="navbar-header" style="min-width:100%">
			...
			<span style="float:right" class="navbar-brand" href="#">
				<span style="color:green">
					<?php $ctr=0; foreach($_SESSION['solved'] as $prob) {if ($prob=='solved') $ctr+=1;}; echo $ctr; ?>
				</span> / 
				<span style="color:red">
					<?php $ctr=0; foreach($_SESSION['solved'] as $prob) {if ($prob=='wrong') $ctr+=1;}; echo $ctr; ?>
				</span> / 
				<?php echo count($probleme)-count($_SESSION['solved']); ?>
			</span>
        </div>
        <!--/.nav-collapse -->
    </div>
...
<div class="container">
    ...
    <div class="row" style="margin-top:30px;margin-bottom:20px">
        <div class="col col-lg-12" style="text-align:center">
				<a class="github-link" href="https://github.com/adrgs/oopquiz" target="_blank">
